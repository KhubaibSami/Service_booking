...
const FilterDropdownItem = ({ id, label, checked, onChange }) => (
...
const Add = () => {
  const [dropdownItems, setDropdownItems] = useState([
    { id: 'apple', label: 'Apple (56)', checked: false },
    { id: 'fitbit', label: 'Fitbit (56)', checked: false },
    { id: 'dell', label: 'Dell (56)', checked: false },
